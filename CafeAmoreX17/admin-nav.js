...
if (navLinks.length >= 6) {
  ...
  navLinks[4].addEventListener('click', () => window.location.href = "inventory.html"); // Inventory
  navLinks[5].addEventListener('click', () => window.location.href = "sales.html"); // Sales
}
